...
alias cds='cd ~/src/'
alias cdi='cd ~/proj/installdrier'
alias cdia='cd ~/proj/installdrier/arch'
alias cdib='cd ~/proj/installdrier/deb'
...
alias pff='find ${PASSWORD_STORE_DIR:=~/proj/password-store/} -name "*.gpg" | sed -e "s@$PASSWORD_STORE_DIR/@@" -e '\''s/\.gpg$//'\'' | fzf | xargs pass show -c'
